...
def syslog(message, level=LEVEL['notice'], facility=FACILITY['local7'],
	host='hostip', port=515):
...
for i in xrange(100000):
	time.sleep(0.001)
	syslog('11 There were zwei peanuts walking down der strasse...warning',level=LEVEL['warning'],facility=23, host='192.168.11.24')
#syslog('22There were zwei peanuts walking down der strasse...emerg',level=LEVEL['emerg'],facility=23, host='192.168.175.101')
