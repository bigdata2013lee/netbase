(function($){
    ...
    m.website_treeWidget = $.extend({}, base_treeWidget, {
        ...
        reload: function(){
            ...
            remoteView.c(remoteMethod_site).
    ...
    m.device_treeWidget = $.extend({}, base_treeWidget, {
        ...
        reload: function(){
            ...
            remoteView.c(remoteMethod_device).
            success(function(data){
                data[0].expanded = true;
                setCount(data[0]);                
                setChecked(data[0]);
    ...
    m.network_treeWidget = $.extend({}, base_treeWidget, {
        ...
        reload: function(){
            ...
            remoteView.c(remoteMethod_network).
            success(function(data){
                data[0].expanded = true;
                setCount(data[0]);                
                setChecked(data[0]);
    ...
    function setCheckeds(dictObj,ids){
        ...
        if($("#_reportObjclass")){
        	var ohtml = "";
        	if($("#_reportObjclass").html().length > 0)
        	{
        		ohtml = $("#_reportObjclass").html()+" "+objclasshtml.join(" ");
        	}
        	else{
        		ohtml = objclasshtml.join(" ");
        	}
        	$("#_reportObjclass").html(ohtml);
        }
