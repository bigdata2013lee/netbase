...
"""
connPerSecond    connPerSecond_connPerSecond    1.3.6.1.4.1.14331.5.5.1.4.10.0//平均每秒的连接数
cpuLoad    cpuLoad_cpuLoad    1.3.6.1.4.1.14331.5.5.1.4.5.0//CPU负载
currentConnection    currentConnection_currentConnection    1.3.6.1.4.1.14331.5.5.1.4.9.0//当前连接数
//memoryLoad    memoryLoad_memoryLoad    1.3.6.1.4.1.14331.5.5.1.4.6.0 //内存负载
"""
def addCPUDataSource(t):
    ...
    dp = DataPoint("CPU")
    dp.set("oid", "1.3.6.1.4.1.14331.5.5.1.4.5.0")
    dp.set("type", "GUAGE")
...
def addMemDataSource(t):
    ...
    mdp = DataPoint("Mem")
    mdp.set("type", "GUAGE")
    mdp.set("oid", "1.3.6.1.4.1.14331.5.5.1.4.6.0")
...
def addConnDataSource(t):
    ...
    dp.set("type", "GUAGE")
    dp.set("oid", "1.3.6.1.4.1.14331.5.5.1.4.10.0")
    ds.addDataPoint(dp)

    mdp = DataPoint("CurConn")
    mdp.set("type", "GUAGE")
    mdp.set("oid", "1.3.6.1.4.1.14331.5.5.1.4.9.0")
...
def createTopSec32884Tpl():
    t=Template("BaseTpl_TopSec32884")
    t.isBaseTpl = True
    t._saveObj()
    addCPUDataSource(t)
    addMemDataSource(t)
