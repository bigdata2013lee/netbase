...
"""
ifInOctets    1.3.6.1.4.1.3375.2.1.2.4.4.3.1.3    DERIVE
ifInUcastPackets    1.3.6.1.4.1.3375.2.1.2.4.4.3.1.2    DERIVE
ifOutOctets    1.3.6.1.4.1.3375.2.1.2.4.4.3.1.5    DERIVE
ifOutUcastPackets    1.3.6.1.4.1.3375.2.1.2.4.4.3.1.4    DERIVE
ifInErrors    1.3.6.1.4.1.3375.2.1.2.4.4.3.1.8    DERIVE
ifOperStatus    1.3.6.1.4.1.3375.2.1.2.4.1.2.1.17    GAUGE
ifOutErrors    1.3.6.1.4.1.3375.2.1.2.4.4.3.1.9    DERIVE

每个数据点的含义见这个包下的  __init__.py文件说明
"""
def createF564_bitInterface():
    """
    创建接口模板
    """
    t = Template("F564_bitInterface")
    t.isBaseTpl = True
    t._saveObj()
    ...
    dp0.set("oid", "1.3.6.1.4.1.3375.2.1.2.4.4.3.1.3")
    dp0.set("type", "DERIVE")
    dp0.set("unit","Bit")
    ...
    dp01.set("oid", "1.3.6.1.4.1.3375.2.1.2.4.4.3.1.5")
    ...
    dp1.set("oid", "1.3.6.1.4.1.3375.2.1.2.4.4.3.1.2")
    dp1.set("type", "DERIVE")
    dp11 = DataPoint("ifOutUcastPackets")
    dp11.set("oid", "1.3.6.1.4.1.3375.2.1.2.4.4.3.1.4")
    ...
    dp2.set("oid", "1.3.6.1.4.1.3375.2.1.2.4.4.3.1.8")
    dp2.set("type", "DERIVE")
    dp21 = DataPoint("ifOutErrors")
    dp21.set("oid", "1.3.6.1.4.1.3375.2.1.2.4.4.3.1.9")
    ...
    dp3.set("oid", "1.3.6.1.4.1.3375.2.1.2.4.1.2.1.17")
    dp3.set("type", "GUAGE")
