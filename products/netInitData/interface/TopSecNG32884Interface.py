...
"""
ifInErrors    1.3.6.1.4.1.14331.5.5.1.5.1.18    DERIVE
ifInOctets    1.3.6.1.4.1.14331.5.5.1.5.1.16    DERIVE
ifInUcastPackets    1.3.6.1.4.1.14331.5.5.1.5.1.15    DERIVE
ifOperStatus    1.3.6.1.4.1.14331.5.5.1.5.1.9    GAUGE
ifOutErrors    1.3.6.1.4.1.14331.5.5.1.5.1.25    DERIVE
ifOutOctets    1.3.6.1.4.1.14331.5.5.1.5.1.23    DERIVE
ifOutUcastPackets    1.3.6.1.4.1.14331.5.5.1.5.1.22    DERIVE

每个数据点的含义见这个包下的  __init__.py文件说明
"""
def createTopSecNG32884Interface():
    """
    创建接口模板
    """
    t = Template("TopSecNG32884Interface")
    t.isBaseTpl = True
    t._saveObj()
    ...
    dp0.set("oid", "1.3.6.1.4.1.14331.5.5.1.5.1.16")
    dp0.set("type", "DERIVE")
    dp0.set("unit","Bit")
    ...
    dp01.set("oid", "1.3.6.1.4.1.14331.5.5.1.5.1.23")
    ...
    dp1.set("oid", "1.3.6.1.4.1.14331.5.5.1.5.1.15")
    dp1.set("type", "DERIVE")
    dp11 = DataPoint("ifOutUcastPackets")
    dp11.set("oid", "1.3.6.1.4.1.14331.5.5.1.5.1.22")
    ...
    dp2.set("oid", "1.3.6.1.4.1.14331.5.5.1.5.1.18")
    dp2.set("type", "DERIVE")
    dp21 = DataPoint("ifOutErrors")
    dp21.set("oid", "1.3.6.1.4.1.14331.5.5.1.5.1.25")
