...
ifOperStatus    1.3.6.1.4.1.14331.5.5.1.5.1.6    GAUGE
...
"""
def createTopSecNG4000Interface():
    """
    创建接口模板
    """
    t = Template("TopSecNG4000Interface")
    t.isBaseTpl = True
    t._saveObj()
    ...
    dp3.set("oid", "1.3.6.1.4.1.14331.5.5.1.5.1.6")
    dp3.set("type", "GUAGE")
